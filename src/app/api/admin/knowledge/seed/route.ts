...
const SEED_DATA = [
  ...
  { category: "Streaks", question: "What is the streak system?", answer: "Submit at least 1 approved clip per day across ANY campaign to maintain your streak. If you miss a day (after the 48-hour grace period), your streak resets to 0. Streak bonuses go up to +10% at 90 days. If all your campaigns are paused, your streak freezes automatically." },
  { category: "Bonus", question: "How do bonuses work?", answer: "Your level, streak, and app install bonuses combine into one total bonus percentage. This bonus increases your earnings on every clip. For example, if you have a +10% bonus and earn $100 from views, you'll get $110 before fees." },
  ...
  { category: "Bonus", question: "How do I increase my bonus?", answer: "Keep your daily posting streak going, level up by earning more, and install the app for an extra +2%. All bonuses stack together." },
  ...
  { category: "Campaigns", question: "How do I join a campaign?", answer: "Just click 'Join Campaign' on any campaign page. You'll be joined instantly — no extra steps needed." },
  ...
  { category: "Clips", question: "What is the posting window?", answer: "You must submit your clip within 2 hours of posting it on the platform. Older clips won't be accepted." },
  { category: "Campaigns", question: "What are CPM Split and Agency Fee?", answer: "These are how campaign owners set up earnings. CPM Split means both the clipper and the agency earn per view. Agency Fee means the agency gets a flat fee. As a clipper, you just earn your CPM — the pricing model doesn't change how you get paid." },
  { category: "Campaigns", question: "What happens when a campaign reaches its budget?", answer: "The campaign automatically pauses. Your earnings and streak are preserved. Join another active campaign to keep clipping." },
  { category: "Campaigns", question: "Can I leave a campaign?", answer: "Yes, go to the campaign page and click 'Leave Campaign'. Your earned clips and earnings stay." },
  ...
  { category: "App", question: "What is the app bonus?", answer: "Install Clippers HQ as an app on your phone for the best experience and a +2% earnings bonus. Look for the 'Download App' button in the sidebar." },
