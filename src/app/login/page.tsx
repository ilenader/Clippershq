    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[#080c10] px-4" style={{ overflow: "hidden" }}>
      ...
      <div className="relative w-full max-w-md animate-[fadeUp_0.6s_ease-out]">
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-8 sm:p-10 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center h-14 w-14 rounded-2xl mb-4" style={{ background: "rgba(0,149,246,0.1)", border: "1px solid rgba(0,149,246,0.2)" }}>
              <svg viewBox="0 0 100 100" className="h-8 w-8" fill="#ffffff">
          ...
          {/* Google sign-in temporarily disabled on the clipper login — Discord only for now.
              /client/login still offers Google for brand clients. */}
          <div className="w-full flex items-center justify-center gap-3 rounded-xl border border-[var(--border-color)] bg-[var(--bg-input)] px-4 py-3.5 mt-3 opacity-50 cursor-not-allowed select-none">
            ...
            <span className="text-sm text-[var(--text-muted)]">Sign In with Google — Coming Soon</span>
          </div>
        ...
        <p className="mt-6 text-center text-xs" style={{ color: "#3a4a5a" }}>
          By signing in, you agree to our <a href="/terms.html" style={{color:"#5a6a7a",textDecoration:"underline"}}>Terms of Service</a> and <a href="/privacy.html" style={{color:"#5a6a7a",textDecoration:"underline"}}>Privacy Policy</a>, including receiving campaign alerts via email and Discord.
        </p>
      </div>
