    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[#080c10] px-4" style={{ overflow: "hidden" }}>
      ...
      <div className="relative w-full max-w-md animate-[fadeUp_0.6s_ease-out]">
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-xl p-8 sm:p-10 shadow-2xl">
          ...
          {/* Google button — for brand clients */}
          <button
            onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
            className="w-full flex items-center justify-center gap-3 rounded-xl px-6 py-4 text-base font-semibold text-white mt-3 cursor-pointer transition-all duration-150 active:scale-[0.98]"
            style={{ background: "#1a1a2e", border: "1px solid rgba(255,255,255,0.06)" }}
            onMouseOver={(e) => (e.currentTarget.style.background = "#222240")}
          ...
          <p className="text-center text-xs mt-1.5" style={{ color: "#5a6a7a" }}>For brand clients only</p>
